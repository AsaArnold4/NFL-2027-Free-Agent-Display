...
st.markdown(
    ...
    <style>
      ...
      /* Dark-control text readability fixes
         Applies the table-header light brown to Streamlit controls that use
         a dark/black backdrop: sort selectbox, multiselect placeholders,
         export CSV, pagination, and back/list buttons. */
      ...
      .stButton button svg {
        color: var(--table-head-text) !important;
        fill: var(--table-head-text) !important;
      }

      /* Selectbox + multiselect closed-state text, including placeholders like
         "Choose options" and "Search and select 2-3 players…" */
...
tab_browse, tab_compare = st.tabs(["Browse", "Compare"])
